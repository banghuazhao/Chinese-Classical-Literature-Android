...
public class StoreHelper {
    ...
    public static void goToMarket(Context context, String packageName) {
        ...
        if (isAvilible(context, "com.android.vending")) {
            // google play
            com.appsbay.chineseclassicalliteratural.Tools.StoreHelper.goToGoogleMarket(context, packageName);
        } else if (isAvilible(context, "com.sec.android.app.samsungapps")) {
            // samsung app store
            com.appsbay.chineseclassicalliteratural.Tools.StoreHelper.goToSamsungappsMarket(context, packageName);
        } else if (isAvilible(context, "com.amazon.venezia")) {
            // amazon app
            com.appsbay.chineseclassicalliteratural.Tools.StoreHelper.goToAmazonMarket(context, packageName);
        } else if (isAvilible(context, "com.xiaomi.market")) {
            // amazon app
            com.appsbay.chineseclassicalliteratural.Tools.StoreHelper.goToXiaoMiMarket(context, packageName);
        } else if (isAvilible(context, "com.oppo.market")) {
            // amazon app
            com.appsbay.chineseclassicalliteratural.Tools.StoreHelper.goToOPPOMarket(context, packageName);
        } else {
            com.appsbay.chineseclassicalliteratural.Tools.StoreHelper.goToGoogleMarket(context, packageName);
        }
